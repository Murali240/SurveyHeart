...
public class EditorQuizEditing {
	...
	public void create_Form_Method() throws IOException {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Update by Editor Test");
	  ...
	  // Wait and select the "Editor" option
	     WebElement editorOption = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@data-value='Editor']") ));   
	     editorOption.click();
	  ...
	  // Editor Signin - Click "Sign in using Email
	     driver.findElement(By.xpath("//span[normalize-space()='Sign in using Email']")).click();
	  ...
	  // Adding Long Question in Builder
	     ...
	     driver.findElement(By.xpath("//span[text()='Settings']")).click();
	     driver.findElement(By.xpath("//span[@class='icon-title'][normalize-space()='Submit']")).click();
	     test.pass("Editor has edited the shared quiz and added a new question : " + dynamicQuizTitle);
