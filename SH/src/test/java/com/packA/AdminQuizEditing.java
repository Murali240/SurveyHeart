...
public class AdminQuizEditing {
	...
	public void create_Form_Method() throws IOException {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Update by Admin Test");
	  ...
	  // Settings screen and Adding Admin collaborator
	     ...
	     driver.findElement(By.xpath("//input[@type='email']")).sendKeys("hawece4785@forcrack.com");
	  ...
	  // Submit button
	     ...
	     test.info("Owner added an admin collaborator successfully : hawece4785@forcrack.com" );
	  ...
	  // Wait for Share popup to appear and close it
	     ...
	     test.info("Share popup closed successfully");
	  ...
	  // Admin Signin - Click "Sign in using Email
	     driver.findElement(By.xpath("//span[normalize-space()='Sign in using Email']")).click();
	     driver.findElement(By.xpath("//label[@id='label_field_Email']")).sendKeys("hawece4785@forcrack.com");
	     driver.findElement(By.xpath("//div[@id='Next']")).click();
	     test.info("Navigated to SurveyHeart login page");
	     
	  // Enter Password
	     WebElement password2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[@id='label_field_Password']")));
	     password2.sendKeys("Automation@2");
	     driver.findElement(By.xpath("//div[@id='Sign in']")).click();
	     test.pass("Admin Signed in successfully");
	     
	  // Dashboard
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@alt='Close']"))).click();
	     test.info("Closed dashboard popup");
	     String currentURL2 = driver.getCurrentUrl();
	     test.info("Current URL after Admin login successfully : " + currentURL2);
	     
	
      // Shared Quiz Dashboard
	     driver.findElement(By.xpath("//span[normalize-space()='Shared']")).click();
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='template-button quiz-template-button']")));
	     driver.findElement(By.xpath("//div[@class='template-button quiz-template-button']")).click();   // Quiz tab
	  ...
	  // Adding Long Question in Builder
	     ...
	     driver.findElement(By.xpath("//span[text()='Settings']")).click();
	     driver.findElement(By.xpath("//span[@class='icon-title'][normalize-space()='Submit']")).click();
	     test.pass("Admin has edited the shared quiz and added a new question : " + dynamicQuizTitle);
      ...
      // Account icon clicking
	     ...
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='Sign Out']")));
	     driver.findElement(By.xpath("//div[@id='Sign Out']")).click();
	     test.info("Admin account is signout : hawece4785@forcrack.com");
	  ...
	  // Edit the Form from Form control
	     ...
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='list-card-title-0']//p[@id='card-form-title']")));
	     driver.findElement(By.xpath("//img[@id='more0']")).click();
	     driver.findElement(By.xpath("//div//p[text()='View Quiz']")).click();
	  ...
	  // Quiz page - Wait for the question count element 
	     WebElement totalQuestionCount = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@id='total_question_count']")));
	  ...
	  // Print in console and report
	     test.info("Total questions verified on the quiz page : " + totalOnlyDigits);
