...
public class QuizFreeUserCreatingwithPremiumQuestion {
	...
	public void quiz_Creation_Method() throws IOException  {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Creation Test");
	  ...
	  // Creating Quiz
	     ...
	     driver.findElement(By.xpath("//span[text()='Add Question']")).click();
	     driver.findElement(By.xpath("//div[@id='question-group-container-1']//div[3]")).click();
	     WebElement premiumWarning = driver.findElement(By.xpath("//div[contains(text(),'PREMIUM_FEATURES')]"));
	     test.pass("Picture Choice Question Warning popup is displayed with :" +premiumWarning.getText());
