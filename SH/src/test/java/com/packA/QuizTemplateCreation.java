...
public class QuizTemplateCreation {
	...
	public void quiz_Creation_Method() throws IOException  {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Template Creation Test");
	  ...
	  // Creating Quiz Template
	     ...
	     driver.findElement(By.xpath("(//div[@id='form-card-0'])[1]")).click();
	     driver.findElement(By.xpath("//span[text()='Settings']")).click();
	     driver.findElement(By.xpath("//span[@class='icon-title'][normalize-space()='Submit']")).click();
	     test.pass("Quiz Template has created successfully");
	  ...
	  // Identifying the created Quiz card in Quiz Dashboard
	     driver.findElement(By.xpath("//span[normalize-space()='Quizzes']")).click(); 
	     ...
	     String expectedQuizTitle="Agriculture";
	     
	     Assert.assertEquals(actualQuizTitle, expectedQuizTitle,"Response text does not match expected value");
	     test.pass("Actual Quiz Template title is matched with the expected Quiz Template title : " + actualQuizTitle);
