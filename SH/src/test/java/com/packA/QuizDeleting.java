...
public class QuizDeleting {

	@Test
	public void quiz_Creation_Method() throws IOException, InterruptedException  {
		
	 // Extent - Initialize Reporter
        ExtentSparkReporter spark = new ExtentSparkReporter("ExtentReports/FormReport.html");
        ExtentReports extent = new ExtentReports();
        extent.attachReporter(spark);
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Deletion Test");
	  ...
	  // Deleting Quiz from Quiz Dashboard
	     ...
	     driver.findElement(By.xpath("//p[normalize-space()='Delete Quiz']")).click();
	  ...
	  // Check if any element matching the deleted form title still exists
	     List<WebElement> deletedForm = driver.findElements(By.xpath("//p[@id='card-form-title' and text()='" + deletedQuizTitle + "']"));
	  ...
	  // Assertion: Form should no longer exist
	     ...
	     test.pass("Quiz deleted successfully :"+ deletedQuizTitle);
