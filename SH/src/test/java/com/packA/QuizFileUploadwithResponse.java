...
public class QuizFileUploadwithResponse {
	...
	public void quiz_Creation_Method() throws IOException  {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Creation with File Upload Test");
	  ...
	  // Generate dynamic form title using timestamp
	     ...
	     String dynamicQuizTitle = "Selenium FUP Quiz - " + timeStamp;
      ...
      // Now submit the form
         ...
         test.pass("Video file is uploaded and successfully form submitted");
	  ...
	  // Identifying the created Form card in Form Dashboard
	     ...
	     String expectedFormTitle = dynamicQuizTitle;
	  ...
	  // Assert that actualTitle and expectedTitle 
	     ...
	     test.pass("Selenium File Quiz  title is matched with expected Form title");  
