...
public class QuizwithAllQuestions {
	...
	public void quiz_Creation_Method() throws IOException  {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Creation with All Question Types");
	  ...
	  // adding Long Question
	     ...
	     driver.findElement(By.xpath("//input[@id='question-text-input-1']")).sendKeys("Quiz Long Question");
	     driver.findElement(By.xpath("//textarea[@aria-label='Label']")).sendKeys("Long Answer");
	     test.pass("Long Question is added");
	     
	  // adding MCQ Question
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='question_card_1']//img[@alt='Add Question']"))).click();
	     driver.findElement(By.xpath("//div[@id='question-group-container-1']//div[@class='question-type-grid-container']//div[1]")).click();
	     driver.findElement(By.xpath("//input[@id='question-text-input-2']")).sendKeys("Quiz MCQ Question");
	     driver.findElement(By.xpath("//input[@id='choice-question-text-input-2-0']")).sendKeys("Alpha");
	     driver.findElement(By.xpath("//img[@alt='Add Option']")).click();
	     driver.findElement(By.xpath("//input[@id='choice-question-text-input-2-1']")).sendKeys("Beta");
	     driver.findElement(By.xpath("(//img[@alt='Add Option'])[2]")).click();
	     driver.findElement(By.xpath("//input[@id='choice-question-text-input-2-2']")).sendKeys("Gamma");
	  ...
	  // adding Dropdown Question
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='question_card_2']//img[@alt='Add Question']"))).click();
	     driver.findElement(By.xpath("//div[contains(text(),'Dropdown')]")).click();
	     driver.findElement(By.xpath("//input[@id='question-text-input-3']")).sendKeys("Quiz Dropdown Question");
	     driver.findElement(By.xpath("//input[@id='choice-question-text-input-3-0']")).sendKeys("Service");
	     driver.findElement(By.xpath("//div[@id='star-body-container3']//img[@alt='Add Option']")).click();
	     driver.findElement(By.xpath("//input[@id='choice-question-text-input-3-1']")).sendKeys("Product");
	  ...
	  // This will locate the correct "+" icon to add 3rd option in dropdown question
	     WebElement addOptionBtn3 = wait.until(ExpectedConditions.elementToBeClickable(
	         By.xpath("(//div[@id='star-body-container3']//img[@alt='Add Option'])[last()]")));
	     addOptionBtn3.click();
	     driver.findElement(By.xpath("//input[@id='choice-question-text-input-3-2']")).sendKeys("Hybrid");
	  ...
	  // adding File Question
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='question_card_3']//img[@alt='Add Question']"))).click();
	     driver.findElement(By.xpath("//div[@id='question-group-container-2']//div[@class='question-type-grid-container']//div[1]")).click();
	     driver.findElement(By.xpath("//input[@id='question-text-input-4']")).sendKeys("Quiz Dropdown Question");
