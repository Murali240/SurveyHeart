...
public class FormUpdating {
	...
	public void create_Form_Method() throws IOException {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Form Update Test");
	  ...
	  // Adding Long Question in Builder
	     ...
	     driver.findElement(By.xpath("//span[text()='Settings']")).click();
	     driver.findElement(By.xpath("//span[@class='icon-title'][normalize-space()='Submit']")).click();
	     test.pass("Form updated with: " + dynamicFormTitle);
	  ...
	  // View icon in Share popup
	   ...
	   // Start button in Welcome page, 
	      WebElement startButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='Start']")));
	      startButton.click();
	      
	   // Form page
	      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[normalize-space()='2. Edited Long Question']")));
	      WebElement editQT = driver.findElement(By.xpath("//span[normalize-space()='2. Edited Long Question']"));
	      String actualTitle = editQT.getText();
	      String expextedAnswer = "Edited Form Long Question";
	   ...
	   // Assert.assertEquals(actualTitle, expextedAnswer, "Response text does not match with expected value");
	      ...
	      test.pass("Form edited and new question added successfully: " + actualTitle);
