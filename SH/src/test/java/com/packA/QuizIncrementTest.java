...
public class QuizIncrementTest {
    ...
    public void form_Creation_With_Response_Method() throws IOException, InterruptedException {
     // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Quiz Increment Test");
     ...
     // Dashboard
      ...
      // User Account icon
	     ...
	     test.info(userCurrentPlan + " user Storage, before quiz submission : " + currentPlanStorage);
	     ...
	     test.info(userCurrentPlan + " user Total Responses, before quiz submission : " + currentPlanResponse);
	  ...
	  // Images
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Images, before quiz submission : " + currentPlanImages);
	    	} catch (Exception e) {
	  ...
	  // Themes
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Themes,  before quiz submission : " + currentPlanThemes);
	    	} catch (Exception e) {
     ...
     // Step 1: Click the Upload area
	  ...
	  // if Follow Us popup then handle it
	     ...
	     //WebElement followUs = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//img[@alt='data:image/svg+xml;base64,'])[1]")));
	     //followUs.click();
	  ...
	  // User Account icon
	     ...
	     String currentPlanStorage2 =  wait.until(ExpectedConditions.visibilityOfElementLocated(
	         By.xpath("//span[contains(text(),'of 1GB Used')]"))).getText();
	     test.info(userCurrentPlan + " user Storage, after quiz submission : " + currentPlanStorage2);

	     String currentPlanResponse2 = wait.until(ExpectedConditions.visibilityOfElementLocated(
	         By.xpath("//span[contains(text(),'of 10000 Used')]"))).getText();
	     test.info(userCurrentPlan + " user Total Responses, after quiz submission : " + currentPlanResponse2);
	  ...
	  // Images
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Images, after quiz submission : " + currentPlanImages2);
	    	} catch (Exception e) {
	    	    test.warning(" User Images usage info not visible or not present for this plan.");
	    	}  
	  ...
	  // Themes
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Themes, after quiz submission : " + currentPlanThemes);
	    	} catch (Exception e) {
	    	    test.warning("User Themes usage info not visible or not present for this plan.");
	    	}
