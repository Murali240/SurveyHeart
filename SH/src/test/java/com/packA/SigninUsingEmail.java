...
public class SigninUsingEmail {
	
	@Test
	public void signIn_Using_Email_Method() throws IOException {
		
	 // Extent - Initialize Reporter
        ExtentSparkReporter spark = new ExtentSparkReporter("ExtentReports/FormReport.html");
        ExtentReports extent = new ExtentReports();
        extent.attachReporter(spark);
        ExtentTest test = extent.createTest("SurveyHeart - Email Sign-In Feature Test");
	  ...
	  // Assert that actualTitle and expectedTitle 
	     ...
	     test.pass("Current URL is matched with expected URL and Form Dashboard is displayed successfully");
