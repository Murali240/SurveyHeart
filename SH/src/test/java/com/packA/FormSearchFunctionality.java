...
public class FormSearchFunctionality {
	...
	public void create_Form_Method() throws IOException {
	    ...
	    ExtentTest test = extent.createTest("SurveyHeart - Form Creation & Search Test");
	    ...
	    test.pass("Search success: Form 1 found - " + formTitle1);
