...
public class DuplicateFormTest {
	...
	public void create_Form_Method() throws IOException {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Form Duplicating Test");
	  ...
	  // Identifying the created Form card in Form Dashboard
	     ...
	     driver.findElement(By.xpath("//p[normalize-space()='Duplicate Form']")).click();
	  ...
	  // Builder screen
	     ...
	     String duplicatedFormTitle = builderScreen.getAttribute("value");
	     test.info("Form got duplicated with : "+duplicatedFormTitle);
	  ...
	  // Assert that actualQuestionTitle and expectedQuestionTitle 
	     ...
	     test.pass("For duplicated Form, Question title is matched successfully");
	  ...
	  // Identifying the created Form card in Form Dashboard
	     ...
	     String expectedFormTitle = duplicatedFormTitle;
	     
	     
	  // Assert that actualTitle and expectedTitle 
	     Assert.assertEquals(actualFormTitle, expectedFormTitle, "Duplicated Form title is matched with the expected title");
	     test.pass("Duplicated Form title is matched with expected form title in Form dashboard");  
