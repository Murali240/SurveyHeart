...
public class FormTemplateCreation {
	...
	public void create_Form_Method() throws IOException {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Form Template Creation Test");
	 ...
	 //  Creating Form Template
	     ...
	     driver.findElement(By.xpath("(//div[@id='form-card-0'])[1]")).click();               // Contact Form
	     //WebElement templateTitle = driver.findElement(By.xpath("//label[@id='label_field_Title']//input[@type='text']"));
	     //System.out.println(templateTitle.getText());
	     driver.findElement(By.xpath("//span[text()='Settings']")).click();
	     driver.findElement(By.xpath("//span[@class='icon-title'][normalize-space()='Submit']")).click();
	     
	     test.pass("Form Template has created successfully");
	  ...
	  // Identifying the created Form card in Form Dashboard
	     driver.findElement(By.xpath("//span[normalize-space()='Forms']")).click();   //Form Dashboard button
	     ...
	     String expectedFormTitle="Contact Form";
	  ...
	  // Assert that actualTitle and expectedTitle 
	     ...
	     test.pass("Actual Form Template title is matched with the expected Form Template title : " + actualFormTitle);
