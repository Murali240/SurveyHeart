...
public class FormTextTypeQuestions {
	...
	public void create_Form_Method() throws IOException {
	 ...
	 // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Create Form (Text Questions) Test");
	 ...
	 // Setting screen
	  ...
	  // Assert that actualTitle and expectedTitle 
	     ...
	     test.pass("Selenium Form title is matched with expected Form title");
