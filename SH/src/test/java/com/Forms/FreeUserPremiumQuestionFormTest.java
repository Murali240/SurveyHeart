...
public class FreeUserPremiumQuestionFormTest {
	
	
	@Test
	public void testFreeUserFormCreationWithPremiumQuestions() throws IOException {
		
	 // Extent - Initialize Reporter
        ExtentSparkReporter spark = new ExtentSparkReporter("ExtentReports/FormReport.html");
        ExtentReports extent = new ExtentReports();
        extent.attachReporter(spark);
        ExtentTest test = extent.createTest("SurveyHeart – Free User Attempt to Add Premium Questions Test");
	  ...
	  // Form Creating
	     ...
	     test.pass("For a "+userCurrentPlan +" user, Slider Question is displayed with : "+premiumWarning1.getText()+ " warning popup");
	     ...
	     test.pass("For a "+userCurrentPlan +" user, Picture Choice Question is displayed with : "+premiumWarning2.getText()+ " warning popup");
	     driver.findElement(By.xpath("//label[normalize-space()='CANCEL']")).click();
	     ...
	     test.pass("For a "+userCurrentPlan +" user, Ranking Question is displayed with : "+premiumWarning3.getText()+ " warning popup");
	     driver.findElement(By.xpath("//label[normalize-space()='CANCEL']")).click();
	     ...
	     test.pass("For a "+userCurrentPlan +" user, Agreement Question is displayed with : "+premiumWarning4.getText()+ " warning popup");
	     driver.findElement(By.xpath("//label[normalize-space()='CANCEL']")).click();
	     ...
	     test.pass("For a "+userCurrentPlan +" user, Signature Question is displayed with : "+premiumWarning5.getText()+ " warning popup");
	  ...
	  // View Plans button
	     ...
	     test.pass("Premium plans page was closed successfully.");
