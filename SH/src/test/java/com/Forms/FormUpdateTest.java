...
public class FormUpdateTest {
	...
	@Test
	public void updateSurveyHeartForm() throws IOException {
	 ...
	 // Extent - Initialize Reporter
	  ...
	  // Edit the Form from Form control 
	     ...
	     test.info("Builder screen get displayed");
	  ...
	  // Adding Long Question in Builder
	     ...
	     driver.findElement(By.xpath("//span[text()='Settings']")).click();
	     driver.findElement(By.xpath("//span[@class='icon-title'][normalize-space()='Submit']")).click();
	     test.pass("Updated form title : " + dynamicFormTitle);
	  ...
	  // View icon in Share popup
	   ...
	   // Print in console and report
		  ...
		  test.pass("Form was successfully updated with a new question : " + dynamicFormTitle);
