...
public class Decrementchecking {
    ...
    public void form_Creation_With_Response_Method() throws IOException, InterruptedException {
     ...
     // Step 1: Click the Upload area
	  ...
	  // Identifying the created Form card in Form Dashboard
	     ...
	     driver.findElement(By.xpath("//p[@id='dashboard-view-responses']")).click();
	  ...
	  // Overview screen
	     ...
	     wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='Delete']"))).click();
