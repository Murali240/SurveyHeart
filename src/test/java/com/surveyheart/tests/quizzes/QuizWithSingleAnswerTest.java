...
/** Test class to verify that a quiz records only a single attempt when Allow Multiple Responses is disabled. */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizWithSingleAnswerTest extends BaseTest {
	
	@Test (groups = "regression", priority = 22)
	public void verifyQuizWithSingleAnswer() {
	 ...
	 // Quiz Dashboard - Initialize the Quiz Dashboard Page object with the current WebDriver instance
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "SingleAnswerQuiz " + System.currentTimeMillis();
