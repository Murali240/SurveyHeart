...
/** Test class to verify file upload question response in a quiz. */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class FileUploadQuizResponseTest extends BaseTest {
	
	@Test (groups = "regression", priority = 18)
	public void verifyFileUploadQuestionResponseForQuiz() throws InterruptedException  {
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "FileUploadQuiz " + System.currentTimeMillis();
	...
	// Quiz page - Initialize the Quiz page object with the current WebDriver instance
	   QuizPage quizPage = new QuizPage(driver);
					...
					ExtentManager.getTest().pass("File uploaded and quiz submitted successfully : <b>" + quizTitle+"</b>");
