...
/** Test class to verify leaderboard rank 2 after the 11th attempt in a quiz */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizLeaderboardRank2Test extends BaseTest {
	
	@Test 
	public void verifyRank2After11thAttempt() {
	 ...
	 // Quiz Dashboard - Initialize the Quiz Dashboard Page object with the current WebDriver instance
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "LeaderboardRank2 " + System.currentTimeMillis();
	 ...
	 // Quiz Results page - Initialize the Quiz Results page object with the current WebDriver instance
	    QuizResultsPage quizResultsPage = new QuizResultsPage(driver);
		          ...
		          // Quiz Leaderboard page on Submitted page
					 ...
					 QuizResultsPage.LeaderboardData scorecardDetails = quizResultsPage.getLeaderboardScorecardDetails(2);
					 ExtentManager.getTest().info("Leaderboard scorecard2 details → "+ scorecardDetails);
