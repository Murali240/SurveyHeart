...
/** Test class to verify that the Undo toast message is displayed in Quiz Individual page. */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizAnswersPageUndoToastMessageTest extends BaseTest {
	
	@Test 
	public void verifyUndoToastMessageDisplayedInQuizAnswers() {
	 ...
	 // Quiz Dashboard - Initialize the Quiz Dashboard Page object with the current WebDriver instance
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "UndoToastMessageInQuizAnswers " + System.currentTimeMillis();
