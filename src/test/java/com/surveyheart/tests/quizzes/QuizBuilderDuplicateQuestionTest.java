...
/** Test class to verify duplicate question functionality in a quiz builder. */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizBuilderDuplicateQuestionTest extends BaseTest {
	...
	public void verifyDuplicateQuestionFunctionality()  {
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "DuplicateQQuiz " + System.currentTimeMillis();
				 ...
				 // Copy Question
				    quizBuilderPage.clickDuplicateQuestionIcon();
	...
	// Quiz page - Initialize the Quiz page object with the current WebDriver instance
	   QuizPage quizPage = new QuizPage(driver);
				    ...
				    ExtentManager.getTest().pass("Question got duplicated successfully in Quiz page: <b>" + quizTitle + "</b>");
