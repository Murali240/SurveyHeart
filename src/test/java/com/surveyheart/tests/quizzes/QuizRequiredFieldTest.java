...
/** Test class to verify required field validation message in Quiz
    Required toggle enabled only for the test question */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizRequiredFieldTest extends BaseTest {
	
	@Test 
	public void verifyQuizRequiredFieldValidationMessage()  {
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "RequiredQuiz " + System.currentTimeMillis();
				    ...
				    quizBuilderPage.clickRequiredToggleSwitchIcon();
	   ...
	   QuizPage quizPage = new QuizPage(driver);
	             ...
	             // Welcome page
	   			 ...
	   			 // Quiz page
	   				...
	   				String requiredMessage = quizPage.getRequiredWarningMessage().getText();
				    ...
				    ExtentManager.getTest().pass("Required field validation message displayed in Quiz page: <b>" + quizTitle + "</b>");
