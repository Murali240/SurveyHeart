...
/** Test class to verify that the Undo toast message is displayed correctly in the Quiz Builder after deleting a question */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizBuilderUndoToastMessageTest extends BaseTest {
	
	@Test 
    public void verifyUndoToastMessageDisplayedInQuizBuilder()  {
		...
		QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
				     ...
				     // Set dynamic Quiz title
						String dynamicQuizTitle = "UndoToastMessageInQuizBuilder " + System.currentTimeMillis();
	...
	// Quiz page - Initialize the Quiz page object with the current WebDriver instance
	   QuizPage quizPage = new QuizPage(driver);
					   ...
					   ExtentManager.getTest().info("Quiz created with: " + questionCount + " question");
