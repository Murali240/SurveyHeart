...
/** Test class to verify leaderboard rank 3 after the 11th attempt in a quiz */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizLeaderboardRank3Test extends BaseTest {
	
	@Test 
	public void verifyRank3After11thAttempt() {
	 ...
	 // Quiz Dashboard - Initialize the Quiz Dashboard Page object with the current WebDriver instance
	    ...
	    QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
	             ...
	             // Set dynamic Quiz title
				    String dynamicQuizTitle = "LeaderboardRank3 " + System.currentTimeMillis();
	...
	// Submitted page - Initialize the Submitted page object with the current WebDriver instance
	 ...
	 // Quiz Results page - Initialize the Quiz Results page object with the current WebDriver instance
	    QuizResultsPage quizResultsPage = new QuizResultsPage(driver);
				  ...
				  // Click on View Leaderboard button on Submitted page
		   			 submittedPage.clickViewLeaderboardButton();
					 ...
					 QuizResultsPage.LeaderboardData scorecardDetails = quizResultsPage.getLeaderboardScorecardDetails(3);
					 ExtentManager.getTest().info("Leaderboard scorecard3 details → "+ scorecardDetails);
