...
/** Test class to verify that an answer can be restored using the Undo toast button in Quiz Tabular page */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizTabularPageRestoreAnswerAfterUndoTest extends BaseTest {
