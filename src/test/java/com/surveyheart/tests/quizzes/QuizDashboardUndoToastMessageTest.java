...
/** Test class to verify the UNDO toast message is displayed in the Quiz Dashboard after deleting a quiz */
@Listeners(com.surveyheart.listeners.TestListener.class)
public class QuizDashboardUndoToastMessageTest extends BaseTest {
	
	@Test 
    public void verifyUndoToastMessageDisplayedInQuizDashboard()  {
		...
		QuizBuilderPage quizBuilderPage = new QuizBuilderPage(driver);
				     ...
				     // Set dynamic Quiz title
						String dynamicQuizTitle = "UndoToastMessageInQuizDashboard " + System.currentTimeMillis();
