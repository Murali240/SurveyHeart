...
public class FormDecrementTest {
    ...
    public void form_Creation_With_Response_Method() throws IOException, InterruptedException {
     // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Form Decrement Test");
     ...
     // Step 1: Click the Upload area
	  ...
	  // User Account icon
	     ...
	     test.info(userCurrentPlan + " user Storage, before form decrement : " + currentPlanStorage);
	     ...
	     test.info(userCurrentPlan + " user Total Responses, before form decrement : " + currentPlanResponse);
	  ...
	  // Images
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Images, before form decrement : " + currentPlanImages);
	    	} catch (Exception e) {
	  ...
	  // Themes
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Themes, before form decrement : " + currentPlanThemes);
	    	} catch (Exception e) {
	  ...
	  // Identifying the created Form card in Form Dashboard
	     ...
	     driver.findElement(By.xpath("//div//p[text()='Edit Form']")).click();                                 // Edit Form
	  ...
	  // THEME UPLOAD
	     ...
	     wait.until(ExpectedConditions.visibilityOfElementLocated
	    	   (By.xpath("//body/div[@id='app']/div/div[@id='app-container']/div[@class='body-container']/div[@class='builder-wrapper']/div[@id='theme-container']/div[@id='default-theme-container']/div[2]/div[1]/img[1]"))).click();  // x delete icon
	  ...
	  // User Account icon
	     ...
	     String currentPlanStorage2 =  wait.until(ExpectedConditions.visibilityOfElementLocated(
	         By.xpath("//span[contains(text(),'of 1GB Used')]"))).getText();
	     test.info(userCurrentPlan + " user Storage, after form decrement : " + currentPlanStorage2);

	     String currentPlanResponse2 = wait.until(ExpectedConditions.visibilityOfElementLocated(
	         By.xpath("//span[contains(text(),'of 10000 Used')]"))).getText();
	     test.info(userCurrentPlan + " user Total Responses, after form decrement : " + currentPlanResponse2);
	  ...
	  // Images
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Images, after form decrement : " + currentPlanImages2);
	    	} catch (Exception e) {
	    	    test.warning(" User Images usage info not visible or not present for this plan.");
	    	}  
	  ...
	  // Themes
	     try {
	    	    ...
	    	    test.info(userCurrentPlan + " user Themes, after form decrement : " + currentPlanThemes2);
	    	} catch (Exception e) {
	    	    test.warning("User Themes usage info not visible or not present for this plan.");
	    	}
