...
public class FormShowSummaryTest {
    ...
    public void form_Creation_With_Response_Method() throws IOException {
     // Extent - Initialize Reporter
        ...
        ExtentTest test = extent.createTest("SurveyHeart - Form Show Summary Test");
     ...
     // Creating Form
        ...
        driver.findElement(By.xpath("//div[@id='settings-responses-box11']//input[@type='checkbox']")).click();
     ...
     // Submitted page
        ...
        if (successMsg.isDisplayed()) {
            test.pass("Form submitted successfully. 'Thanks for completing this form' message is displayed.");
        }
        
        
     // Clicking on Response Summary button
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='Response Summary']")));
        driver.findElement(By.xpath("//div[@id='Response Summary']")).click();
        
     // Get Summary page URL
		String summaryURL = driver.getCurrentUrl();
		test.pass("Summary page URL : " +summaryURL);
		
		String trendingSurveys = driver.findElement(By.xpath("//h2[normalize-space()='Trending Surveys']")).getText();
		test.info("Summary page displayed with : "+trendingSurveys);

		
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='GET STARTED']")));
		WebElement getStartedButton = driver.findElement(By.xpath("//div[@id='GET STARTED']"));
		
		String isDisplayed = String.valueOf(getStartedButton.isDisplayed()).toUpperCase();
		test.info("Is 'Get Started' button displayed? : " + isDisplayed);

     // test.info("Summary page displayed the Get Started button : " +getStartedButton.isDisplayed());

	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='Selenium short question form response']")));
		WebElement shortAnswer = driver.findElement(By.xpath("//p[normalize-space()='Selenium short question form response']"));
		test.pass("Responder entered text is : "+shortAnswer.getText());
